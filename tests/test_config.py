...
class TestConfig:
    ...
    def test_multiple_validation_errors(self):
        ...
        assert "Invalid configuration: force_brackets must be a boolean value" in str(excinfo.value)
    ...
    def test_validate_method(self):
        ...
        with patch.object(Config, '__post_init__', return_value=None):
            ...
            # Manually set an invalid value
            invalid_config.force_brackets = "True"
            assert invalid_config._validate() == "force_brackets must be a boolean value"
